...
<body>
    <div class="exe3">
        <a href="codesource.php?page=afficherEtudiants.php" class="btn btn-link">Voir le code source ici</a>
                ...
                <table class='table table-responsive mx-auto max-w-4xl w-full whitespace-nowrap rounded-lg bg-white divide-y divide-gray-300 overflow-hidden table-hover table-striped'>
                    ...
                    <td class="px-6 py-4 text-center mx-auto text-center"> ' . $row[2] . ' </td>
                        ...
                        <span class="badge badge-primary text-white  bg-primary font-semibold px-2 rounded-full w-100">
                         <a style="text-decoration: none;color: white" href="modifierEtudiant.php?CNE=' . $row[0] . '&&nom=' . $row[1] . '&&codeClasse=' . $row[2] . '" >Modifier</a><br>
                        ...
                        <a style="text-decoration: none;color: white"  href="supprimerEtudiant.php?CNE=' . $row[0] . '" >Supprimer</a></span>  </td>
                </tr>');
                        }
                        ?>
