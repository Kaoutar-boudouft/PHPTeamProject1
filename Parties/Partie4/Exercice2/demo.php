            ...
            <div class='overflow-x-auto w-full'>
                <table class='table table table-responsive mx-auto max-w-4xl w-full  rounded-lg bg-white '>
                    ...
                    <tr>
                        ...
                        <td class="pt-2" > <span class="badge badge-secondary text-white  bg-secondary font-semibold px-2 rounded-full"> <a style="text-decoration: none;color: white" href="./matieresManagement/add.php" >Ajouter</a><br></span><br><span class="badge badge-primary text-white text-sm w-1/3 pb-1 bg-primary font-semibold px-2 rounded-full"><a style="text-decoration: none;color: white"  href="./matieresManagement/showAll.php" >Afficher</a></span>  </td>
                        <td class="px-6 py-4 text-center"><?php
